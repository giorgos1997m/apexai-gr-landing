...
export const Mission = ({ locale }: MissionProps) => {
  ...
  const content = {
    gr: {
      ...
      description: 'Στην APEX AI, πιστεύουμε ότι κάθε επιχείρηση αξίζει να έχει πρόσβαση σε αυτοματισμούς τελευταίας τεχνολογίας. Η αποστολή μας είναι να δημοκρατικοποιήσουμε την τεχνητή νοημοσύνη, κάνοντάς την προσιτή, αποτελεσματική και απίστευτα εύκολη για επαγγελματίες που θέλουν να εστιάσουν στο αυτό που κάνουν καλύτερα — να εξυπηρετούν τους πελάτες.',
      stats: [
